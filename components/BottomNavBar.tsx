...
import { LayoutDashboard, GanttChartSquare, Settings, MessageCircle, Briefcase, Lightbulb } from 'lucide-react';
...
export const BottomNavBar: React.FC = () => {
    ...
    return (
        <nav className="fixed bottom-0 left-0 right-0 h-20 bg-black/80 backdrop-blur-lg border-t border-granite-gray/20 z-40 grid grid-cols-6 md:hidden">
            ...
            <NavItem icon={<Lightbulb size={24} />} text="Oportun." active={currentPage === 'Oportunidades'} onClick={() => setCurrentPage('Oportunidades')} />
