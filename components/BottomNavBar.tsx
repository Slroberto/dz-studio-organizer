...
import { LayoutDashboard, GanttChartSquare, GalleryHorizontal, Settings, CalendarRange } from 'lucide-react';
...
export const BottomNavBar: React.FC = () => {
    ...
    return (
        <nav className="fixed bottom-0 left-0 right-0 h-16 bg-black/80 backdrop-blur-lg border-t border-granite-gray/20 z-40 flex md:hidden">
            ...
            <NavItem icon={<CalendarRange size={24} />} text="Timeline" active={currentPage === 'Linha do Tempo'} onClick={() => setCurrentPage('Linha do Tempo')} />
            <NavItem icon={<GalleryHorizontal size={24} />} text="Galeria" active={currentPage === 'Galeria'} onClick={() => setCurrentPage('Galeria')} />
