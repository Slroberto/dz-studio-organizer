...
export const GOOGLE_CLIENT_ID = (typeof process !== 'undefined' ? process.env.GOOGLE_CLIENT_ID : undefined) || 'FAKE_CLIENT_ID.apps.googleusercontent.com';

// The API key for your project from Google Cloud Console.
// Example: GOOGLE_API_KEY="AIzaSy..."
export const GOOGLE_API_KEY = (typeof process !== 'undefined' ? process.env.GOOGLE_API_KEY : undefined) || 'FAKE_API_KEY';
...
export const GOOGLE_SHEETS_ID = (typeof process !== 'undefined' ? process.env.GOOGLE_SHEETS_ID : undefined) || 'FAKE_SHEETS_ID';

// The ID of the root folder in Google Drive where OS folders will be created.
// Example: GOOGLE_DRIVE_FOLDER_ID="4d5e6f..."
export const GOOGLE_DRIVE_FOLDER_ID = (typeof process !== 'undefined' ? process.env.GOOGLE_DRIVE_FOLDER_ID : undefined) || 'FAKE_DRIVE_FOLDER_ID';
